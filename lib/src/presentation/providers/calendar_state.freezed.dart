...
abstract class $CalendarStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({DateTime startDate, DateTime endDate, DateTime? selectedDate});
}
...
class _$CalendarStateImpl implements _CalendarState {
  const _$CalendarStateImpl(
      {required this.startDate, required this.endDate, this.selectedDate});
  ...
  @override
  String toString() {
    return 'CalendarState(startDate: $startDate, endDate: $endDate, selectedDate: $selectedDate)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, startDate, endDate, selectedDate);
...
abstract class _CalendarState implements CalendarState {
  const factory _CalendarState(
      ...
      final DateTime? selectedDate}) = _$CalendarStateImpl;
